...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setGeometry(20,30,700,700)

        layout = QVBoxLayout()
        layout.setContentsMargins(20,20,20,20)
        self.editor = TextEdit()

        #self.editor.setMargin(10)
...
########################## File Menu       #########################
        ...
        open_html_action = QAction(QIcon(os.path.join('images', 'blue-folder-open-document.png')), "Open html...", self)
        open_html_action.setStatusTip("Open html File")
        open_html_action.triggered.connect(self.file_html_open)
        file_menu.addAction(open_html_action)
        file_toolbar.addAction(open_html_action)
        ...
        self.font_color_action = QAction(QIcon(os.path.join('images', 'fontColor.png')), "Color", self)
        self.font_color_action.setStatusTip("Font Color")
        #self.font_color_action.setShortcut(QKeySequence.Italic)
        self.font_color_action.setCheckable(True)
        self.font_color_action.toggled.connect(self.setColor)
        format_toolbar.addAction(self.font_color_action)
    ...
    def file_html_open(self):
        ...
        try:
            ...
            self.showhtml.showhtml(text)
            self.showhtml.show()
            self.update_title()

    def update_title(self):
        self.setWindowTitle("%s - Rich Formatted Text Editor" % (os.path.basename(self.path) if self.path else "Untitled"))
    ...
    def image_open(self):
        ...
        self.editor.insertFromMimeData(fileName)
    ...
    def checkText(self):
        ...
        for line in text:
            ...
            if errors:
                print('Paragraph'+str(cnt)+' Spell Error : '+', '.join(errors))
            else:
                print('Paragraph'+str(cnt)+': Looks Good!')
    ...
    def correctText(self):
        ...
        for line in text:
            ...
            self.editor.append(' '.join(correctErrors))
        self.statusBar().showMessage("Spellings Corrected!")

if __name__ == '__main__':

    app = QApplication(sys.argv)
    app.setApplicationName("Rich Formatted Text Editor")
